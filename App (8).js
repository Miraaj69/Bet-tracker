    ...
    onPanResponderRelease: (_, g) => {
      ...
      if (g.dx < -THRESH) {
        setTab(prev => {
          ...
          if (next !== prev) {
            Animated.timing(swipeAnim,{toValue:-SW,duration:180,useNativeDriver:true}).start(()=>swipeAnim.setValue(0));
  ...
  return (
    <SafeAreaProvider>
      ...
      <View style={{flex:1,backgroundColor:t.bg}}>
        ...
        {/* FAB action items — centered above FAB button */}
        {showFab&&(
        ...
        {/* Bottom nav — Dream11-style blurred pill */}
        <SafeAreaView edges={['bottom']} style={{position:'absolute',bottom:0,left:0,right:0,zIndex:100}}>
          <View style={{paddingHorizontal:12,paddingBottom:10,paddingTop:6}}>
            <View style={{
              ...
              paddingVertical:7,
              paddingHorizontal:6,
              // Note: use expo-blur BlurView wrapper for full blur on Android
              // On iOS this semi-transparent bg gives a blur-like effect
            }}>

              {/* Left tabs: Dash, Bets, Stats */}
              ...
              <TouchableOpacity onPress={()=>setShowDrawer(true)} activeOpacity={0.7}
                style={{
                  alignItems:'center',justifyContent:'center',flex:1,
                  paddingVertical:6,borderRadius:32,minWidth:44,
                }}>
                <Svg width="22" height="22" viewBox="0 0 24 24" fill="none">
