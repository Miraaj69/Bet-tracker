        ...
        <SafeAreaView edges={['bottom']} style={{position:'absolute',bottom:0,left:0,right:0,zIndex:100}}>
          <View style={{paddingHorizontal:12,paddingBottom:10,paddingTop:6}}>
            <View style={getDepthStyle('nav', isLightTheme(t) ? 'rgba(90,110,255,0.34)' : '#000')}>
              ...
              {/* Home */}
              <NavTabItem icon="🏠" name="Home" active={tab===0} onPress={()=>setTab(0)} t={t} accent={t.accent} iconStyle={iconStyle}/>

              {/* Insights */}
              <NavTabItem icon="📊" name="Insights" active={tab===1} onPress={()=>setTab(1)} t={t} accent={t.accent} iconStyle={iconStyle}/>
              ...
              {/* Bets */}
              <NavTabItem icon="📋" name="Bets" active={tab===3} onPress={()=>setTab(3)} t={t} accent={t.accent} iconStyle={iconStyle}/>

              {/* Profile */}
              <NavTabItem icon="👤" name="Profile" active={tab===4} onPress={()=>setTab(4)} t={t} accent={t.accent} iconStyle={iconStyle}/>
                </View>
              </View>
            </View>
          </View>
