...
export default function App() {
    ...
    return (
      <SafeAreaView style={styles.webContainer}>
        <View style={styles.webCard}>
          ...
          <Text style={styles.subtitle}>Web preview ke liye GitHub Pages wali docs/index.html use karo.</Text>
        </View>
  ...
  return (
    <View style={styles.root}>
      ...
      {/* WebView — always visible, no opacity animation */}
...
const styles = StyleSheet.create({
  ...
  logoWrap: {
    ...
    shadowOpacity: 0.6, shadowRadius: 28, elevation: 20,
  },
  ...
  webContainer: { flex: 1, backgroundColor: '#050816', alignItems: 'center', justifyContent: 'center', padding: 24 },
  webCard:      { width: '100%', maxWidth: 560, backgroundColor: '#111827', borderRadius: 20, padding: 24, borderWidth: 1, borderColor: '#1f2937' },
