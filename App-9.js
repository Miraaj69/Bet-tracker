...
// ─── DASHBOARD ────────────────────────────────────────────────────────────────
function Dashboard({bets, t, onAddBet, onQuickAdd, onSettlePending}) {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      {/* AI Insights */}
      <AIInsightsCard bets={bets} t={t}/>

      {/* Goal Setting */}
      <GoalCard bets={bets} t={t}/>

      {/* Rolling Performance */}
      <RollingPerformanceCard bets={bets} t={t}/>

      {/* Yearly Heatmap */}
      <YearlyHeatmap bets={bets} t={t}/>

      {/* Losing Patterns */}
      <LosingPatternsCard bets={bets} t={t}/>

      {/* Variance Meter */}
      <VarianceMeterCard bets={bets} t={t}/>

      {/* Odds Comparison */}
      <OddsComparisonCard t={t}/>

      {/* Period Comparison */}
      {bets.length>=5&&<PeriodComparisonCard bets={bets} t={t}/>}
...
const NAV_ICONS = {
  ...
  'Bets': ({color}) => (
    <Svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      ...
      <Path d="M8 13H10M14 13H16" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
    </Svg>
  ),
  'Stats': ({color}) => (
    <Svg width="22" height="22" viewBox="0 0 24 24" fill="none">
  ...
  'Bank': ({color}) => (
    <Svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <Path d="M12 3L21 8H3L12 3Z" fill={color} opacity="0.85"/>
      <Path d="M5 8V17M9 8V17M15 8V17M19 8V17" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
      <Path d="M3 17H21" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
  ...
  'Calc': ({color}) => (
    <Svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      ...
      <Rect x="7" y="5" width="10" height="4" rx="1" fill={color} opacity="0.5"/>
  ...
  'Report': ({color}) => (
    <Svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <Path d="M14 2H6C5.45 2 5 2.45 5 3V21C5 21.55 5.45 22 6 22H18C18.55 22 19 21.55 19 21V7L14 2Z" stroke={color} strokeWidth="1.8" fill="none" strokeLinejoin="round"/>
      <Path d="M14 2V7H19" stroke={color} strokeWidth="1.8" strokeLinejoin="round"/>
      <Path d="M8 13H16M8 17H13" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
    </Svg>
  ),
  'Awards': ({color}) => (
    <Svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <Path d="M6 3H18V11C18 14.31 15.31 17 12 17C8.69 17 6 14.31 6 11V3Z" stroke={color} strokeWidth="1.8" fill="none" strokeLinejoin="round"/>
      <Path d="M18 5H20C21.1 5 21 5.9 21 7V8C21 9.65 19.65 11 18 11" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
      <Path d="M6 5H4C2.9 5 3 5.9 3 7V8C3 9.65 4.35 11 6 11" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
      <Path d="M12 17V20M9 20H15" stroke={color} strokeWidth="1.8" strokeLinecap="round"/>
          ...
          <View style={{paddingHorizontal:12,paddingBottom:10,paddingTop:6}}>
            <View style={{
              ...
              {TABS.slice(0,3).map(([icon,name],i)=>(
                <NavTabItem key={i} icon={icon} name={name} active={tab===i}
                  onPress={()=>setTab(i)} t={t} accent={t.accent}/>
              ))}
              ...
              <View style={{width:52,alignItems:'center',justifyContent:'center'}}>
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    shadowOpacity:0.55,shadowRadius:14,shadowOffset:{width:0,height:3},
                    borderWidth:2,borderColor:'rgba(255,255,255,0.18)',
                  }}
                >
                  <Text style={{color:'#fff',fontSize:28,fontWeight:'200',lineHeight:32,includeFontPadding:false}}>
                    {showFab?'✕':'＋'}
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              {TABS.slice(3,6).map(([icon,name],i)=>(
                <NavTabItem key={i+3} icon={icon} name={name} active={tab===i+3}
                  onPress={()=>setTab(i+3)} t={t} accent={t.accent}/>
              ))}

              <TouchableOpacity onPress={()=>setShowDrawer(true)} activeOpacity={0.7}
                style={{alignItems:'center',justifyContent:'center',flex:1,paddingVertical:6,borderRadius:32,minWidth:44}}>
                <Svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <Path d="M4 6H20M4 12H20M4 18H20" stroke="rgba(180,140,140,0.62)" strokeWidth="1.9" strokeLinecap="round"/>
                </Svg>
                <Text style={{fontSize:9.5,color:'rgba(180,140,140,0.65)',fontWeight:'500',letterSpacing:0.2,marginTop:3}}>More</Text>
              </TouchableOpacity>
            </View>
          </View>
        </SafeAreaView>
